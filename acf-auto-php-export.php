...
if (!class_exists('acf')) {
    ...
    require_once dirname(__FILE__) . '/lib/utility-functions.php';
        ...
        <?php
            ...
            function save_post($post_id, $post) {
                ...
                if (isset($_POST['ID'])) {
                    ...
                    /* cmnt_log_to_file($_POST['ID'], get_home_path() . '/cement.log'); */

                    $field_group_fields = acf_get_fields($_POST['ID']);
                    ...
                    /* code */
                    $code = acf_auto_php_export_improved_var_export($field_group, true);
